...
function virtualEmail(reg) {
  ...
  const details = vbox(`<b style="color:#0f1b2d">Event</b>&nbsp;&nbsp;Virtual Embedded - Hardware + AI Buildathon<br><b style="color:#0f1b2d">Date</b>&nbsp;&nbsp;Saturday, August 9, 2026<br><b style="color:#0f1b2d">Platform</b>&nbsp;&nbsp;Discord<br><b style="color:#0f1b2d">Track</b>&nbsp;&nbsp;${c.track}`);
  ...
  const body = para(`Hi ${firstName(reg)},`)
    ...
    + para(`We are hosting a <b style="color:#0f1b2d">Virtual Embedded Buildathon on August 9th (Saturday)</b>, and you're invited. Same tools, same challenge, same chance to build something real. The only difference is you'll be building from wherever you are.`)
    + para(c.intro)
...
function virtualText(reg) {
  ...
  return `Hi ${(reg.fullName || 'there').split(' ')[0]},\n\n`
    ...
    + `We are hosting a Virtual Embedded Buildathon on August 9th (Saturday), and you're invited. Same tools, same challenge, same chance to build something real. The only difference is you'll be building from wherever you are.\n\n`
    + c.intro.replace(/<[^>]+>/g, '') + `\n\n`
