...
const { SUBJECTS, pendingEmail, pendingText, approvedEmail, approvedText, rsvpRequestEmail, rsvpRequestText, rsvpReminderEmail, rsvpReminderText, eventReminderEmail, eventReminderText } = require('./emailContent');
...
module.exports = { sendPending, sendApproved, sendRsvpRequest, sendRsvpReminder, sendEventReminder };
