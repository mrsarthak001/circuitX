...
const { SUBJECTS, pendingEmail, pendingText, approvedEmail, approvedText, rsvpRequestEmail, rsvpRequestText, rsvpReminderEmail, rsvpReminderText, eventReminderEmail, eventReminderText, rsvpFinalEmail, rsvpFinalText, virtualEmail, virtualText, virtualSubject, virtualRsvpEmail, virtualRsvpText } = require('./emailContent');
...
const sendVirtualRsvp = (reg) => sendEmail(reg.email, SUBJECTS.virtualRsvp, virtualRsvpEmail(reg), virtualRsvpText(reg));

module.exports = { sendPending, sendApproved, sendRsvpRequest, sendRsvpReminder, sendEventReminder, sendRsvpFinal, sendVirtual, sendVirtualRsvp };
