...
const { SUBJECTS, pendingEmail, pendingText, approvedEmail, approvedText, rsvpRequestEmail, rsvpRequestText } = require('./emailContent');
...
module.exports = { sendPending, sendApproved, sendRsvpRequest };
